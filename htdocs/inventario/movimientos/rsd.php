...
if($action=="del"){mysql_query("DELETE FROM rsd WHERE id=$id;");}
...
if($cprov != "" && $cprod != "" && $cantidad != "") { mysql_query("INSERT INTO rsd (f, cprov, cprod, cantidad) VALUES ('$folio', '".$existeproducto['cprov']."', '".$existeproducto['cprod']."', '$cantidad' );");}
...
<?if($action == "fin") { 
session_destroy(); 
mysql_query("delete from rsd where f = $folio and cprov ='' and cprod =0;");
