...
mysql_query("delete from rst where f = $folio and cprov ='' and cprod =0;");
...
if($action=="del")	{mysql_query("DELETE FROM rst WHERE id=$id;");}
...
if($cprov != "" && $cprod != "" && $cantidad != "") { mysql_query("INSERT INTO rst (f, cprov, cprod, cantidad) VALUES ('$folio', '".$existeproducto['cprov']."', '".$existeproducto['cprod']."', '$cantidad' );");}
