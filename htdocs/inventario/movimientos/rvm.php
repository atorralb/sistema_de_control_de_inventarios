...
mysql_query("delete from rvm where f = $folio and cprov ='' and cprod =0;");
...
if($action=="del")	{mysql_query("DELETE FROM rvm WHERE id=$id;");}
...
if($cprov != "" && $cprod != "" && $cantidad != "") { mysql_query("INSERT INTO rvm (f, cprov, cprod, cantidad) VALUES ('$folio', '".$existeproducto['cprov']."', '".$existeproducto['cprod']."', '$cantidad' );");}
